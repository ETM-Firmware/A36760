...
#define FAULT_MASK_HIGH_VOLTAGE_STATE_HV_ON         (FAULT_ARC_OVER_COUNT_CONSECUTIVE | FAULT_ARC_OVER_COUNT_FAST | FAULT_ARC_OVER_COUNT_SLOW | FAULT_HV_LAMBDA_SUM_FAULT | FAULT_HV_LAMBDA_VPEAK_OVER_VOLTAGE | FAULT_HV_LAMBDA_VPEAK_UNDER_VOLTAGE)
