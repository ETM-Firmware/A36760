...
#define FAULT_THYR_UNUSED_1                       0x0400
...
#define FAULT_MASK_MAGNETRON_STATE_WARM_READY       (FAULT_HW_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_OV_HARD_LIMIT | FAULT_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_UV | FAULT_MAGNETRON_FILAMENT_OC | FAULT_MAGNETRON_FILAMENT_UC | FAULT_HW_MAGNETRON_MAGNET_COOR | FAULT_MAGNETRON_MAGNET_OC_HARD_LIMIT | FAULT_MAGNETRON_MAGNET_OC | FAULT_MAGNETRON_MAGNET_UC | FAULT_MAGNETRON_MAGNET_OV | FAULT_MAGNETRON_MAGNET_UV)
#define FAULT_MASK_THYRATRON_STATE_WARM_READY       (NO_FAULTS)
#define FAULT_MASK_HIGH_VOLTAGE_STATE_WARM_READY    (NO_FAULTS)
#define FAULT_MASK_CONTROL_BOARD_STATE_WARM_READY   (FAULT_THYRATRON_OVER_TEMP)
...
#define FAULT_MASK_MAGNETRON_STATE_HV_ON            (FAULT_HW_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_OV_HARD_LIMIT | FAULT_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_UV | FAULT_MAGNETRON_FILAMENT_OC | FAULT_MAGNETRON_FILAMENT_UC | FAULT_HW_MAGNETRON_MAGNET_COOR | FAULT_MAGNETRON_MAGNET_OC_HARD_LIMIT | FAULT_MAGNETRON_MAGNET_OC | FAULT_MAGNETRON_MAGNET_UC | FAULT_MAGNETRON_MAGNET_OV | FAULT_MAGNETRON_MAGNET_UV)
#define FAULT_MASK_THYRATRON_STATE_HV_ON            (NO_FAULTS)
#define FAULT_MASK_HIGH_VOLTAGE_STATE_HV_ON         (FAULT_ARC_OVER_COUNT_CONSECUTIVE | FAULT_ARC_OVER_COUNT_FAST | FAULT_ARC_OVER_COUNT_SLOW | FAULT_HV_LAMBDA_SUM_FAULT | FAULT_HV_LAMBDA_VPEAK_OVER_VOLTAGE | FAULT_HV_LAMBDA_VPEAK_UNDER_VOLTAGE | FAULT_HV_LAMBDA_EOC_TIMEOUT)
#define FAULT_MASK_CONTROL_BOARD_STATE_HV_ON        (FAULT_LAMBDA_OFF | FAULT_THYRATRON_OVER_TEMP)
...
#else
// We are operating in Ari's bench top mode.  Need to enable the external interlock inputs
...
#define FAULT_MASK_THYRATRON_STATE_WARM_UP          (NO_FAULTS)
#define FAULT_MASK_HIGH_VOLTAGE_STATE_WARM_UP       (NO_FAULTS)
#define FAULT_MASK_CONTROL_BOARD_STATE_WARM_UP      (FAULT_NO_WATER_FLOW)
...
#define WARNING_MASK_THYRATRON_STATE_WARM_FAULT     (NO_FAULTS)
#define WARNING_MASK_HIGH_VOLTAGE_STATE_WARM_FAULT  (NO_FAULTS)
#define WARNING_MASK_CONTROL_BOARD_STATE_WARM_FAULT (FAULT_NO_WATER_FLOW)
