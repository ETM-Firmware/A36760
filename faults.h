...
#define FAULT_MASK_MAGNETRON_STATE_WARM_READY       (FAULT_HW_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_OV_HARD_LIMIT | FAULT_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_UV | FAULT_MAGNETRON_FILAMENT_OC | FAULT_MAGNETRON_FILAMENT_UC)
#else
#define FAULT_MASK_MAGNETRON_STATE_WARM_READY       (FAULT_HW_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_OV_HARD_LIMIT | FAULT_MAGNETRON_FILAMENT_OV FAULT_MAGNETRON_FILAMENT_OC | FAULT_MAGNETRON_FILAMENT_UC)
#endif
...
#ifndef __MK_POWER_SUPPLIES
#define FAULT_MASK_MAGNETRON_STATE_HV_ON            (FAULT_HW_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_OV_HARD_LIMIT | FAULT_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_UV | FAULT_MAGNETRON_FILAMENT_OC | FAULT_MAGNETRON_FILAMENT_UC)
#else
#define FAULT_MASK_MAGNETRON_STATE_HV_ON            (FAULT_HW_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_OV_HARD_LIMIT | FAULT_MAGNETRON_FILAMENT_OV | FAULT_MAGNETRON_FILAMENT_OC | FAULT_MAGNETRON_FILAMENT_UC)
#endif


#define FAULT_MASK_THYRATRON_STATE_HV_ON            (NO_FAULTS)
#define FAULT_MASK_HIGH_VOLTAGE_STATE_HV_ON         (FAULT_ARC_OVER_COUNT_FAST | FAULT_ARC_OVER_COUNT_SLOW | FAULT_HV_LAMBDA_SUM_FAULT)
#ifndef __SELECT_ARI_BENCHTOP_MODE
